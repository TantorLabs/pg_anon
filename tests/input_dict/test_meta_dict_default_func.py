{
    "field": {  # must be anonymized without scanning
        "rules": ["^fld_5_em", "^amount", "details$", "contract_expires$", "inn$"],
        "constants": ["usd", "имя_поля"],
    },
    "skip_rules": [
        {
    ...
    "data_const": {"constants": ["account", "email", "слово", "сергей"]},
    "sens_pg_types": ["text", "integer", "bigint", "character", "json"],
    "funcs": {
        "default": "anon_funcs.digest(\"%s\", 'by_default_func', 'sha256')",
    },
}
