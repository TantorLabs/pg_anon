{
    "dictionary": [
        {"schema": "schm_other_1", "table": "some_tbl", "fields": {"val": "'text const'"}},
        {
            "schema": "schm_other_2",
            "table": "some_tbl",
        ...
        },
        {
            ...
            "fields": {"_FLD.$complex#имя;@&* a'": "'text const'"},
        },
        {
            "schema": "_SCHM.$complex#имя;@&* a'",
        ...
        {"schema_mask": "^schm_mask_incl", "table_mask": "^some_t", "fields": {"val": "'text const'"}},
        {"schema_mask": "^schm_mask_incl", "table": "tbl_123", "fields": {"val": "'text const'"}},
        {"schema": "schm_mask_include_1", "table_mask": r"\w+\_\d+\_\d+", "fields": {"val": "'text const'"}},
    ],
    "dictionary_exclude": [{"schema": "schm_other_2", "table": "exclude_tbl"}],
}
