    ...
    "dictionary": [
        {
            ...
            "fields": {
                "_FLD.$complex#имя;@&* a'": (
                    "anon_funcs.digest(\"_FLD.$complex#имя;@&* a'\", 'by_default_func', 'sha256')"
                ),
        ...
        },
        {
            ...
            "fields": {"phone": "anon_funcs.digest(\"phone\", 'by_default_func', 'sha256')"},
        },
        {
            "schema": "schm_mask_ext_exclude_2",
            "table": "card_numbers",
        ...
        },
        {
            ...
            "fields": {"field_type_int8": "anon_funcs.digest(\"field_type_int8\", 'by_default_func', 'sha256')"},
        },
        {
            "schema": "schm_customer",
        ...
        },
        {
            "schema": "public",
            "table": "inn_info",
            "fields": {"inn": "anon_funcs.digest(\"inn\", 'by_default_func', 'sha256')"},
        },
        {
            "schema": "schm_other_2",
            "table": "tbl_test_anon_functions",
            "fields": {"fld_5_email": "anon_funcs.digest(\"fld_5_email\", 'by_default_func', 'sha256')"},
        },
    ]
}
