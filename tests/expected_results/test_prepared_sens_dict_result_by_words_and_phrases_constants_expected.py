{
    "dictionary": [
        ...
        },
        {
            ...
            "table": "tbl_constants",
            "fields": {
                "phrases_sens_2": "anon_funcs.digest(\"phrases_sens_2\", 'salt_word', 'md5')",
                "phrases_sens_1": "anon_funcs.digest(\"phrases_sens_1\", 'salt_word', 'md5')",
                "words_sens": "anon_funcs.digest(\"words_sens\", 'salt_word', 'md5')",
            },
        },
        {
            "schema": "schm_customer",
            "table": "customer_manager",
            "fields": {"phone": "anon_funcs.digest(\"phone\", 'salt_word', 'md5')"},
        },
        {
        ...
        },
        {
            "schema": "public",
            "table": "inn_info",
            "fields": {"inn": "LPAD((10000000 + ROW_NUMBER() OVER (ORDER BY inn))::TEXT, 8, '0')"},
        },
        {
            "schema": "schm_other_2",
            "table": "tbl_test_anon_functions",
            "fields": {"fld_5_email": "anon_funcs.digest(\"fld_5_email\", 'salt_word', 'md5')"},
        },
    ]
}
