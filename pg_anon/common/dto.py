...
class RunOptions:
    ...
    verbose: Optional[VerboseOptions] = VerboseOptions.INFO
    ...
    clear_output_dir: Optional[bool] = False
    dbg_stage_1_validate_dict: Optional[bool] = False
    dbg_stage_2_validate_data: Optional[bool] = False
    dbg_stage_3_validate_full: Optional[bool] = False
    ...
    drop_custom_check_constr: Optional[bool] = False
    seq_init_by_max_value: Optional[bool] = False
    disable_checks: Optional[bool] = False
    clean_db: Optional[bool] = False
    drop_db: Optional[bool] = False

    # view-fields options
    view_only_sensitive_fields: Optional[bool] = False
