...
| `--orm-dict-file`              | No       | Path to a JSON file with the ORM storage structure. Replaces table and field names in the output with their ORM names.                                                                                                                             |

---

## ORM names translation
